...
// ----------------- Firebase Config -----------------
#define DATABASE_URL "https://fireguard360-e8f63-default-rtdb.asia-southeast1.firebasedatabase.app/"  // Your RTDB URL
#define API_KEY "AIzaSyCllG2iY7lsYv6y8msPpj5fh6NrHdMomw0"  // Copy from Firebase Console → Project Settings → General → Web API Key
