// ============================================
// RADAR SCREEN DISPLAY - OVERLAP FIXED
// STEAMX Academy
// ============================================
...
void drawText() {
  ...
  stroke(98, 245, 31);
  strokeWeight(1);
  line(width * 0.30, height - height * 0.0648,
       width * 0.30, height);
  line(width * 0.60, height - height * 0.0648,
       width * 0.60, height);
  noStroke();

  // Section 1 — Channel name (left)
  fill(98, 245, 31);
  textSize(26);
  text("STEAMX Radar",
       width * 0.02,
  ...
  // Section 2 — Angle (center)
  textSize(26);
  text("Angle: " + iAngle + " deg",
       width * 0.32,
       height - height * 0.0150);

  // Section 3 — Distance (right) ← FIXED: single combined string
  textSize(26);
  if (iDistance < 40) {
    text("Distance: " + iDistance + " cm",
         width * 0.62,
         height - height * 0.0150);
  } else {
